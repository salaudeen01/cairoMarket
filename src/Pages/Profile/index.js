    ...
    render() {
        return (
            <div class="container">
                ...
                <div className="mb-2 type="button class="btn btn-link" class="text-center" style={{marginLeft:"20px"}}>
            <h1><a href="#"> Edit Profile</a></h1>
              </div>
              <br/>
              <div class="card" class="container">
  <div class="row" class="text-center" style={{marginRight:"10px"}}>
...
<br/>
<div class="container" class="col-sm-10" style={{marginLeft:"90px"}}>
    <div class="row g-3">
  <div class="col">
