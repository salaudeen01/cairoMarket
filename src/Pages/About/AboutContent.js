...
const AboutContent = () =>{
   {
        return (
            <div>
                <section className="about-wrap-layout1 padding-top-10 padding-bottom-7 bg--accent">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6 col-12">
                                    <div className="about-box-layout1">
                                        <h2 className="item-title title-bar">What We Do</h2>
                                        <p className="strong-paragraph">Dorem ipsum dolor sit amet, consectetur adipisicing elit.
