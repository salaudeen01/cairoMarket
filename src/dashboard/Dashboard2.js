            ...
            <div className="container-fluid">
                <div className="row text-center page">
                    ...
                    <div className="page col-sm-9"><br/>
                        ...
                        <marquee><p>Tristack inc is an organisation that is specialized in computer science and technology initialization and installation.</p></marquee>
